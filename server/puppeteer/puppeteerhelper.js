 ...
 */
module.exports.getHTML = (selector, page) =>
 ...
 */
module.exports.getTxt = (selector, page) =>
  new Promise(async (resolve, reject) => {
    try {
      let txt = "";
      const isNode = await page.$(selector);
 ...
 */
module.exports.getTxtMultiple = (selector, page) =>
  new Promise(async (resolve, reject) => {
    try {
      let txt = [];
      const isNode = await page.$(selector);
 ...
 */
module.exports.getAttr = (selector, attribute, page) =>
  new Promise(async (resolve, reject) => {
    try {
      let attr = "";
      const isNode = await page.$(selector);
 ...
 */
module.exports.getAttrMultiple = (selector, attribute, page) =>
  new Promise(async (resolve, reject) => {
    try {
      let attr = [];
      const isNode = await page.$(selector);
